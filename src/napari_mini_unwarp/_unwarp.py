...
# Comment Horst: 
# Following a discussion here: https://forum.image.sc/t/equivalent-for-matlabs-piecewiselineartransformation2d/51035
# the Matlab implementation of "piecewise linear transformation" differs from the way scikit image handles equivalent cases 
# ("piecewise affine transformation"). 
# An implementation of the updated version is going to be implemented into scikit-image (thin plate spline warping): 
# https://github.com/scikit-image/scikit-image/issues/2429 . It will probably be implemented in the same way as the current 
# implementation of "piecewise affine transformations" that are in use throughout datajoint imaging at the moment.
# Until this is finished I am taking Zachary's code as is and build around it. 
